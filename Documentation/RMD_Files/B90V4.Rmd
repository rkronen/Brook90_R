...
First the script of the main programm (MainProg.Rmd) has to be rendered to run the script of B90V4.Rmd in R-Markdown.
...
Parameter initializations are done for New Run, Rerun and Continue Run. First some parameters are converted. Then the equivalent slope for radiation calculations is extracted with the help of [Function EQUIVSLP](./sun.html). Other initialized parameters are:

...
* timeseries_prec - precipitation (points)
* timeseries_evp - evaporation (blue line)
* timeseries_mesfld - measured flow (darkgreen line)
* timeseries_flow - total flow (darkgreen line)

```{r}
plot(1:NDAYS,timeseries_flow[1:NDAYS],col="red",type="l",lwd=3,ylim=c(0.0, 70),xlab="Tage [d]",ylab="Werte [mm/d]")
...
lines(1:NDAYS,timeseries_mesfld,col="red",lwd=2)
lines(1:NDAYS,timeseries_flow,col="darkgreen",lwd=3)
```

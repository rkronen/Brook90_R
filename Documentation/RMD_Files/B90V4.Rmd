...
The plot will be saved in the same directory as your R- or Rmd-file is located. 
...
plot(1:NDAYS,timeseries_flow[1:NDAYS],col="red",type="l",lwd=3,ylim=c(0.0,50),xlab="Day [d]",ylab="Value [mm/d]", main = "Model results")

...
#
	...
	#save.image(paste("d:\\Nutzer\\RKronenberg\\Desktop\\EXTRUSO\\R_scripte\\DATA_h\\",toString(IDAY),".RData"))
	
} #End B90

plot(1:NDAYS,floww[1:NDAYS],col="red",type="l",lwd=3,ylim=c(0.0, 70),xlab="Tage [d]",ylab="Werte [mm/d]")#,xlim=c(IDAY,NDAYS+1))
...
lines(1:NDAYS,mesfld,col="darkgreen",lwd=2)

...
The first step is to change the "projectpath" in both scripts, the B90V4.Rmd and [MainProg.Rmd](https://github.com/rkronen/Brook90_R/blob/master/Rmd_files/MainProg.Rmd) script. After downloading the data the script path has to look like this:

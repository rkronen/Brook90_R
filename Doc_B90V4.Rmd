...
```{r}
SCRIPTPATH<-"c:\\Users\\LM\\Documents\\BROOK90\\R_scripte\\"
source(file.path(SCRIPTPATH,"MainProg.R"))
...
Parameter initializations are done for New Run, Rerun and Continue Run. First some parameters are converted. Then the equivalent slope for radiation calculations is extracted with the help of [Function EQUIVSLP](./doc_sun.html). Other initialized parameters are:
